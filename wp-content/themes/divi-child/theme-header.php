...
<div id="top-header" <?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
    <div class="container clearfix">
        ...
        <div id="et-info">
            ...
            <span
                id="et-info-phone">
				<a href="<?php echo et_core_esc_previously( et_sanitize_html_input_text('tel:' . $et_phone_number ) ); ?>">
					<?php echo et_core_esc_previously( et_sanitize_html_input_text( $et_phone_number ) ); ?>
				</a>
			</span>
            <?php endif; ?>
    ...
    <div class="container clearfix et_menu_container">
		...
		?>
            ...
            <div class="right-social-icon">
                ...
                <div id="et_top_search" class="main-header-search">
                    <span class="icon-coolicon" id="et_search_icon"></span>
                </div>


                <div id="et_top_user">
                    <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><span
                            class="icon-coolicon1"></span></a>
                </div>
				...
				if ( ! $et_top_info_defined && ( ! $et_slide_header || is_customize_preview() ) ) {
					...
					echo '<span class="cart_product_count"><div class="header-cart-count">'.WC()->cart->get_cart_contents_count().'</div></span>';
				}
				?>
                <div id="et_top_phone_number">Call us :
                    <a class="telephone_number" href="tel:+866 670 9700"> 866 670 9700</a>
                </div>
